  ...
  $.ajax({
    ...
    success: function (data) {
      var editor = grapesjs.init({
        container : '#content',
        // canvas: {
        //   styles: ['https://res.cloudinary.com/moviesstore-com/raw/upload/v1613462214/Css/gjs-base.css', ]
        // },
        storageManager:{
          type: 'remote',
          autosave: true,
          urlStore: 'http://localhost:4144/store-page?id=1',
        },
        // styleManager: { clearProperties: true },
        // plugins: ['gjs-blocks-basic', 'gjs-blocks-avance'],
      ...
      // editor.BlockManager.add('.myblocks',{
      //   category: {
      //     label:'My Cat Label',
      //     order: 2,
      //     open: false
      ...
      editor.setComponents(data.description)
    },
